...
syntax keyword ttCommands #send #ses[sion] #show[me] #snoop #spe[edwalk] #sp[lit] #sub[stitute] #suspend #system 
syntax keyword ttCommands #tab #textin #ti[ck] #unact[ion] #unalias #unfunction #ungag #unhighlight
syntax keyword ttCommands #unmacro #unpath #unprompt #unsplit #unsubstitute #untab #untic[k] #unvar[iable]
syntax keyword ttCommands #var[iable] #walk #write #zap #gts #event #run #script
syntax keyword ttCommands #switch #case #default #line
...
syntax match ttVar /\$\%[{]\w\+/ "matches variables that are going to be expanded / preceded by the '$' symbol
